...
export function buildSystemPrompt(): string {
  ...
  parts.push(
    ...
    `- Respond to the user in ${langName}. Tool arguments and SQL stay as-is (use the real identifiers).`,
    "",
    "State / freshness:",
    ...
    "",
    "Response style:",
    "- After calling `open_query_tab` or `edit_current_query`, a ONE-LINE confirmation is enough (e.g., \"Abri a aba com o SELECT.\"). DO NOT repeat the full SQL in the text — the UI already shows the tool call. If the user asks to see the SQL, THEN paste it.",
