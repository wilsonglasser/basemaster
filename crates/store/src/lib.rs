...
pub use saved_transfers::{SavedTransfer, SavedTransferDraft, SavedTransferRepo};
...
impl Store {
    ...
    pub fn saved_transfers(&self) -> SavedTransferRepo<'_> {
        SavedTransferRepo::new(&self.pool)
    }
