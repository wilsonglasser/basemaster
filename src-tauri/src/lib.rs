...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::data_transfer_start_multi,
            ...
            commands::saved_transfers_list,
            commands::saved_transfers_get,
            commands::saved_transfers_create,
            commands::saved_transfers_update,
            commands::saved_transfers_delete,
